...
bot = TeleBot(token='5416364096:AAG7nLWqivDXCtjT1FgsXFFUPBTSPClfbHU', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Привет, {0.first_name}! Я умею генерировать номер тестовой банковской карты\nВыбери тип карты:'.format(message.from_user, bot.get_me()), # текст сообщения
